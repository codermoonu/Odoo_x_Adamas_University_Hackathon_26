...
export const dummyProfileData = {
    ...
    // TODO: none of the fields below have a backend field/endpoint yet - local-only until one exists
    company: "QuickHRMS",
    department: "Engineering",
    manager: "Alex Matthew",
    location: "Remote - USA",
    ...
    // TODO: statutory config - local-only until a real salary-structure endpoint exists
    pfRate: 12,
    professionalTax: 200,
};

// TODO: Salary Information tab (Payslips.jsx) - local-only wage/component calculator seed data,
// no backend endpoint for salary structure exists yet
export const dummySalaryStructure = {
    wage: 50000,
    components: [
...
// TODO: Salary Info tab reuses this shape (matches payslip records in Payslips.jsx/PrintPayslip.jsx)
// until it's wired up to fetch the real latest payslip from /payslips
export const dummySalaryData = {
    basicSalary: 40000,
    allowances: 10000,
    deductions: 2000,
    netSalary: 48000,
