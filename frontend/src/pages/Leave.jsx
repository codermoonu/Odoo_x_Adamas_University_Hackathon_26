...
const Leave = () => {
  ...
  const leaveStats = [
    {label: "Sick", value: sickCount, icon: ThermometerIcon},
    {label: "Paid", value: casualCount, icon: UmbrellaIcon},
    {label: "Unpaid", value: annualCount, icon: PalmtreeIcon},
  ]
  ...
  return (
    <div className="animate-fade-in">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
        <div>
          <h1 className="page-title text-orange-100">Leave Management</h1>
